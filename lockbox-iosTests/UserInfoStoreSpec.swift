            ...
            describe("populating initial values") {
                describe("ProfileInfo") {
                    ...
                    describe("when only uid has been saved in the keychain") {
                        ...
                        it("passes an empty profileinfo to subscribers") {
                            expect(profileInfoObserver.events.first!.value.element).to(equal(ProfileInfo.Builder().build()))
                        }
                    }
                ...
                describe("scopedKey") {
                    ...
                    describe("when the scopedKey has not previously been saved to the keychain") {
                        ...
                        it("pushes an empty key to key observers") {
                            expect(keyObserver.events.first!.value.element).to(equal(""))
                        }
                    }
                }
                ...
                describe("OAuthInfo") {
                    ...
                    describe("when not all tokens have been saved in the keychain") {
                        ...
                        it("passes an empty OAuthInfo to subscribers") {
                            expect(oAuthInfoObserver.events.first!.value.element).to(equal(OAuthInfo.Builder().build()))
                        }
                    }
